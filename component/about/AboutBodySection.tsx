    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
      ...
      <div className="text-gray-600 leading-relaxed">
        ...
        <p className="mb-4">
          ...
          fashion. We&apos;re dedicated to giving you the very best of apparel,
          footwear, and accessories, with a focus on quality, customer service,
          and uniqueness.
        </p>
        <p className="mb-4">
          ...
          and stylish clothing drove us to do intense research, and gave us the
          impetus to turn hard work and inspiration into to a booming online
          store. We now serve customers all over the country, and are thrilled
          to be a part of the quirky, eco-friendly, fair trade wing of the
          fashion industry.
        </p>
        <p>
